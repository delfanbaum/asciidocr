...
_We have output_! You can now convert, for example, this README (minus the usage
listing block above) using the `asciidocr` command to a fairly bare-bones HTML
more or less along the lines of what O'Reilly's
https://oreillymedia.github.io/HTMLBook/[HTMLBook] expects.
